...
| #  | 内容                                       | 時間 |
|----|--------------------------------------------|------|
| 1  | オープニング（到達目標・時間配分の説明）   | 4分  |
| 2  | 設定ファイル（CLAUDE.md・メモリ・settings.json） | 9分 |
| 3  | Skills とプラグイン           | 10分 |
| 4  | Hooks                         | 6分  |
| 5  | MCP（Figma MCP）              | 6分  |
...
#### 6-3. gh で GitHub リポジトリを作成してコミット & push（2分）
